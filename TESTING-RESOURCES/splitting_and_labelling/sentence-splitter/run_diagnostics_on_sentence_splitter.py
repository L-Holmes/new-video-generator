...
# This test lives under TESTING-RESOURCES/, three folders down from the repo
# root; PATHS (over in ___splitting_and_labelling/shared/) puts every stage
# folder on sys.path, so `import sentence_splitter` works from anywhere.

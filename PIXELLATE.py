...
input_path = "stickman-CACHE/stickman_scenes/In_fact_to_secure_a_monopoly_on_nutmeg_t_5ed929a6_0.png"
output_path = "temp/pixellated.png"


TARGET_PIXELLATION_WIDTH = 400 # smaller = more pixellated
TARGET_PIXELLATION_HEIGHT = 200 # smaller = more pixellated
TOLLERANCE_OUT_OF_256 = 80

# The target "pixel" grid size 
grid_size = (TARGET_PIXELLATION_WIDTH, TARGET_PIXELLATION_HEIGHT)
...
def process_image():
    ...
    try:
        ...
        tolerance = TOLLERANCE_OUT_OF_256  

...
The board base images live in .resources/reusable-images/. Each one has a rectangular
...
Standalone smoke test (grabs a random file from the stock-footage cache):
    ...
    python make_explainer_img.py --source-dir .CACHE/spices-CACHE/stock_footage
    python make_explainer_img.py --media .resources/reusable-images/foo.png --base 2
...
from CONFIG import REUSABLE_IMAGES_DIR
...
BOARD_CONFIGS: list[dict] = [
    {
        "path":  str(REUSABLE_IMAGES_DIR / "board-einstein-1.png"),
        "board": {"left": 220, "top": 11, "right": 986, "bottom": 466},
    },
    {
        "path":  str(REUSABLE_IMAGES_DIR / "board-einstein-2.png"),
        "board": {"left": 220, "top": 11, "right": 986, "bottom": 466},
    },
    {
        ...
        "path":  str(REUSABLE_IMAGES_DIR / "board-big.png"),
...
DEFAULT_SOURCE_DIR = ".CACHE/spices-CACHE/stock_footage"

...
from CONFIG import AI_REFERENCE_IMAGES_DIR, resolve_group_continuations
from ___visuals.ai.postprocess import deai_postprocess, save_clean

# -- Reference images for style grounding --------------------------------
REF_IMAGES = [
    str(AI_REFERENCE_IMAGES_DIR / "stick1.jpg"),
    str(AI_REFERENCE_IMAGES_DIR / "stick2.jpg"),
    str(AI_REFERENCE_IMAGES_DIR / "stick3.jpg"),
]
...
# -- SHARED ROBUST CALL CORE (used by stickman AND edit) ---------------

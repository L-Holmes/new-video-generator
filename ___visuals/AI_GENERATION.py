...
per-scene regenerators used by the review GUIs, and the ai_edit stage
(generate + review chained AI edits one scene at a time).

The fal / ai_edit / ai_generate_stickman_images dependencies are imported
...
# Allow running this file directly from the repo root (uv run ___visuals/AI_GENERATION.py).

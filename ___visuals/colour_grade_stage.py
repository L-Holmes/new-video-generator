...
# Allow running this file directly from the repo root (uv run ___visuals/colour_grade_stage.py).
...
# stickman / edit / read-out / maps / pure text overlays are intentionally

...
Every file in `TESTING-RESOURCES/images/stock-cinematic-test-stock/` is graded with the one
...
_TEST_SRC_DIR = (_MODULE_DIR.parent / "TESTING-RESOURCES" / "images"
                 / "stock-cinematic-test-stock")
